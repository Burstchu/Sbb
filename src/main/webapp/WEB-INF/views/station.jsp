...
<%@ page import="ru.tsystems.school.dto.TrainDto" %>
<%@ page import="ru.tsystems.school.model.Train" %>
		...
		<div class="container-fluid mt-3">
			<table class="table">
				...
				<tr>
					...
					<td>
						<c:forEach var="tempStation" items="${allTrains}">
							<p>
								<c:out value="${tempStation.trainNumber}"/>
							</p>
						</c:forEach>
					</td>
					<td>
